...
import com.tryouts.finalyearproject.databinding.FragmentSensor2Binding
...
@AndroidEntryPoint
class Sensor2Fragment : Fragment() {

    private lateinit var binding: FragmentSensor2Binding
    private lateinit var sharedPreferencesClass: SharedPreferencesClass
    private lateinit var viewModel: Sensor2ViewModel
    ...
    override fun onCreateView(
        ...
        binding = FragmentSensor2Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initViewModel() {
        viewModel = ViewModelProvider(requireActivity()).get(Sensor2ViewModel::class.java)
    ...
    private fun saveAttackData ( it : OutputData) {
        if ( it.prediction == "attack" )
        {
            ...
            val attackData = AttackData( currentDateAndTime , "Sensor 2" )
